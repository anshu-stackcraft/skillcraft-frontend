...
const Class10 = () => {
  const subjects = [
    { id: 1, name: "Hindi", path: "/class10/hindi" },
    { id: 2, name: "English", path: "/class10/english" },
    { id: 3, name: "Maths", path: "/class10/maths" },
    { id: 4, name: "SST", path: "/class10/sst" },
    { id: 5, name: "Science", path: "/class10/science" },
  ];
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="text-center py-24 px-6 bg-linear-to-br from-black via-zinc-900 to-black">
        <h1 className="text-4xl md:text-6xl font-extrabold mb-6">
          Class 10 <span className="text-orange-500">Subjects</span>
        </h1>
