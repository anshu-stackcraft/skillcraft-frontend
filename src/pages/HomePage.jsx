    ...
    <div className="bg-black text-white overflow-hidden">
      ...
      >
        <div className="text-center md:text-left max-w-xl">
          <h1 className="text-3xl sm:text-5xl md:text-6xl font-extrabold leading-tight">
            CBSE Class <span className="text-orange-500">9 to 12</span>
            <br />
          ...
          <div className="flex justify-center md:justify-start gap-4">
            ...
            <Link
              to="/freeclasses"
              className="border border-orange-500 px-7 py-3 rounded-xl font-semibold hover:bg-orange-500 hover:text-black transition-all duration-200 active:scale-95"
            >
              Free Classes
            </Link>
          </div>
      ...
      <section className="py-24 px-6 md:px-24 bg-zinc-950">
        ...
        <div className="grid md:grid-cols-3 gap-10 text-center">
          {[
            { icon: <FaChalkboardTeacher size={35} />, title: "Expert Teaching" },
            { icon: <FaBookOpen size={35} />, title: "Complete Study Material" },
            { icon: <FaUsers size={35} />, title: "Live Doubt Support" },
          ].map((item) => (
            <Motion.div
              key={item.title}
              whileHover={{ scale: 1.08 }}
      ...
      <section className="py-24 bg-black text-center px-6">
        ...
        >
          <p className="text-gray-400 text-lg">
            "This coaching completely changed my preparation level. Concepts are
            explained step-by-step and doubt sessions are very helpful. I improved
            my marks from 65% to 92%."
          </p>
          <h4 className="mt-4 font-semibold text-orange-500">- Class 10 Student</h4>
        </Motion.div>
      </section>
